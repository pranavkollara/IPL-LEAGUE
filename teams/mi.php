...
$play = "SELECT * from teams WHERE team LIKE 'mi';";
...
if (isset($_POST['submit'])) {
    ...
    if ($result = $conn->query($sql_query)) {
        while ($row = $result->fetch_assoc()) {
            ...
            $update = $played + 1;
            $sql_update_team = "UPDATE `teams` SET `played` = '$update' WHERE `teams`.`team` = 'mi';";
...
<body>
    ...
    <?php
    echo "<h1 class='text-center my-4'>MI MATCH NO {$played}</h1>";
    ?>
    <div class="container">
        <form action="mi.php" method="post" class="text-center">
        ...
        <form method="post" action="team_edit.php">
            ...
            <input name="team" id="team" class="d-none" value="mi"></input>
            <button type="submit" id="submit" name="submit" class="btn btn-primary">Submit</button>
        </form>
    </div>
    <?php $team_team = 'mi' ?>
