...
$play = "SELECT * from teams WHERE team LIKE 'rcb';";
...
if (isset($_POST['submit'])) {
    ...
    if ($result = $conn->query($sql_query)) {
        while ($row = $result->fetch_assoc()) {
            ...
            $update = $played+1;
            $sql_update_team ="UPDATE `teams` SET `played` = '$update' WHERE `teams`.`team` = 'rcb';";
...
echo "<h1 class='text-center my-4'>RCB MATCH NO {$played}</h1>";
    ?>
    <div class=" container">
        <form action="rcb.php" method="post">
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <tr>
                                <th scope="row">
                                    ...
                                    if (file_exists("rcb/$player.png")) {

                                        echo "<img style='margin-left:5px;width:10vw;min-width:50px' src='rcb/$player.png'>";
                                    } else {
        ...
        <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <input name="team" id="team" class="d-none" value="rcb"></input>
        <button type="submit" id="submit" name="submit" class="btn btn-primary">Submit</button>            
       </form>
    </div>
    <?php $team_team = 'rcb' ?>      
