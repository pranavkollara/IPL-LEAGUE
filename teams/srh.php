...
$play = "SELECT * from teams WHERE team LIKE 'srh';";
...
if (isset($_POST['submit'])) {
    ...
    if ($result = $conn->query($sql_query)) {
        while ($row = $result->fetch_assoc()) {
            ...
            $update = $played+1;
            $sql_update_team ="UPDATE `teams` SET `played` = '$update' WHERE `teams`.`team` = 'srh';";
...
echo "<h1 class='text-center my-4'>SRH MATCH NO {$played}</h1>";
    ?>
    <div class=" container">
        <form action="srh.php" method="post">
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <tr>
                                <th scope="row">
                                    ...
                                    if (file_exists("srh/$player.png")) {

                                        echo "<img style='margin-left:5px;width:10vw;min-width:50px' src='srh/$player.png'>";
                                    } else {
        ...
        <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <input name="team" id="team" class="d-none" value="srh"></input>
        <button type="submit" id="submit" name="submit" class="btn btn-primary">Submit</button>            
       </form>
    </div>
